...
# 环境变量
UUID = os.environ.get('UUID', '1240712b-1514-4161-adb8-9ef1e6e7ebc7')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.wbxl.dpdns.org:443')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'eQznXSiec5C101xYWVMZQiTrpVUnEAFc')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
